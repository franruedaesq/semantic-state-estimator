/* @ts-self-types="./semantic_state_core.d.ts" */
...
export class WasmStateEngine {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmStateEngineFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmstateengine_free(ptr, 0);
    }
    /**
     ...
     */
    get_snapshot(now_ms) {
        const ret = wasm.wasmstateengine_get_snapshot(this.__wbg_ptr, now_ms);
        if (ret[2]) {
     ...
     */
    constructor(alpha, drift_threshold) {
        const ret = wasm.wasmstateengine_new(alpha, drift_threshold);
        this.__wbg_ptr = ret >>> 0;
        WasmStateEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     * @returns {any}
     */
    update(embedding, now_ms) {
        const ptr0 = passArrayF32ToWasm0(embedding, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmstateengine_update(this.__wbg_ptr, ptr0, len0, now_ms);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
if (Symbol.dispose) WasmStateEngine.prototype[Symbol.dispose] = WasmStateEngine.prototype.free;
 ...
 */
export function wasm_normalize(v) {
    const ptr0 = passArrayF32ToWasm0(v, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wasm_normalize(ptr0, len0);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./semantic_state_core_bg.js": import0,
    };
}

const WasmStateEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmstateengine_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('semantic_state_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
